(function(){
    ...
    QUnit.test( "private.OptionParser", function( assert ) {
        ...
        assert.equal(knots[0].attachedAccessPoint.accessPoint, "name");
        assert.equal(knots[0].attachedAccessPoint.pipes.length, 0);
        ...
        assert.equal(knots[1].attachedAccessPoint.accessPoint, "name");
        assert.equal(knots[1].attachedAccessPoint.pipes.length, 1)
        assert.equal(knots[1].attachedAccessPoint.pipes[0], "nullToBool");
        ...
        assert.equal(knots[0].attachedAccessPoint.isCompositeAccessPoint, true);
        assert.equal(knots[0].attachedAccessPoint.nToOnePipe, "trueWhenAllTrue");
        assert.equal(knots[0].attachedAccessPoint.accessPoints.length, 2);
        assert.equal(knots[0].attachedAccessPoint.accessPoints[0].accessPoint, "isLogged");
        assert.equal(knots[0].attachedAccessPoint.accessPoints[0].pipes.length, 0);
        assert.equal(knots[0].attachedAccessPoint.accessPoints[1].accessPoint, "userId");
        assert.equal(knots[0].attachedAccessPoint.accessPoints[1].pipes.length, 1);
        assert.equal(knots[0].attachedAccessPoint.accessPoints[1].pipes[0], "trueWhenNot0");
